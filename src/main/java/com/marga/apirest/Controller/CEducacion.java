...
import com.marga.apirest.Dto.dtoEducacion;

import com.marga.apirest.Educacion.Educacion;

import com.marga.apirest.Service.SEducacion;
...
@CrossOrigin(origins  = {"https://http://localhost:4200/"})
public class CEducacion {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(sEducacion.existsByNombreEdu(dtoeducacion.getNombreEdu()) && sEducacion.getByNombreEdu(dtoeducacion.getNombreEdu()).get()
                .getId()!= id)
            return new ResponseEntity(new Mensaje("La educacion ya existente"),HttpStatus.BAD_REQUEST);
        if(StringUtils.isBlank(dtoeducacion.getNombreEdu()))
